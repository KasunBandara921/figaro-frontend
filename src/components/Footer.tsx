      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-gray-800 pt-8">
          <p className="text-gray-400 text-center">
            Created by <a href="https://eclipse.srl" target="_blank" rel="noopener noreferrer" className="text-white hover:text-yellow-400">Kasun Bandara</a> | © 2026 Figaro Salon. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
